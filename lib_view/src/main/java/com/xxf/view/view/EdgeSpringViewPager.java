 ...
 * 滑动边缘有返回效果
 */
public class EdgeSpringViewPager extends ViewPager {
    ...
    public EdgeSpringViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.EdgeSpringViewPager);
        mOverscrollTranslation = a.getDimension(R.styleable.EdgeSpringViewPager_overscroll_translation_bounce,
                DEFAULT_OVERSCROLL_TRANSLATION);
        mOverscrollAnimationDuration = a.getInt(R.styleable.EdgeSpringViewPager_overscroll_animation_duration_bounce,
