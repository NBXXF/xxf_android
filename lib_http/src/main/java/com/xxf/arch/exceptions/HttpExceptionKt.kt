...
val HttpException.rawRequest: okhttp3.Request? get() = rawResponse?.request
val HttpException.rawHeaders: okhttp3.Headers? get() = rawResponse?.headers
val HttpException.rawBody: okhttp3.ResponseBody? get() = rawResponse?.body
