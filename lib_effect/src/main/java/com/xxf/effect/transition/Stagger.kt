...
package com.xxf.effect.transition
...
const val LARGE_EXPAND_DURATION = 600L
 ...
 * 用法
 *   val stagger = Stagger()
 *   TransitionManager.beginDelayedTransition(binding.recyclerView, stagger)
 *   源码来自:git@github.com:android/animation-samples.git
 */
