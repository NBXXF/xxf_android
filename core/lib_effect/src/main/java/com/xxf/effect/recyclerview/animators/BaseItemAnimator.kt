...
import com.xxf.effect.recyclerview.animators.holder.AnimateViewHolder
import com.xxf.effect.recyclerview.internal.ViewHelper.clear
...
abstract class BaseItemAnimator : SimpleItemAnimator() {
  ...
  private val pendingMoves = ArrayList<com.xxf.effect.recyclerview.animators.BaseItemAnimator.MoveInfo>()
  private val pendingChanges = ArrayList<com.xxf.effect.recyclerview.animators.BaseItemAnimator.ChangeInfo>()
  private val additionsList = ArrayList<ArrayList<RecyclerView.ViewHolder>>()
  private val movesList = ArrayList<ArrayList<com.xxf.effect.recyclerview.animators.BaseItemAnimator.MoveInfo>>()
  private val changesList = ArrayList<ArrayList<com.xxf.effect.recyclerview.animators.BaseItemAnimator.ChangeInfo>>()
  ...
  override fun animateMove(
    ...
    pendingMoves.add(
      com.xxf.effect.recyclerview.animators.BaseItemAnimator.MoveInfo(
        holder,
        fX,
        fY,
        toX,
  ...
  private fun animateMoveImpl(
    ...
    animation.setDuration(moveDuration).setListener(object : com.xxf.effect.recyclerview.animators.BaseItemAnimator.AnimatorListenerAdapter() {
  ...
  override fun animateChange(
    ...
    pendingChanges.add(
      com.xxf.effect.recyclerview.animators.BaseItemAnimator.ChangeInfo(
        oldHolder,
        newHolder,
        fromX,
        fromY,
  ...
  private fun animateChangeImpl(changeInfo: com.xxf.effect.recyclerview.animators.BaseItemAnimator.ChangeInfo) {
    ...
    if (view != null) {
      ...
      oldViewAnim.alpha(0f).setListener(object : com.xxf.effect.recyclerview.animators.BaseItemAnimator.AnimatorListenerAdapter() {
        override fun onAnimationStart(animator: Animator) {
    ...
    if (newView != null) {
      ...
      newViewAnimation.translationX(0f).translationY(0f).setDuration(changeDuration).alpha(1f)
        .setListener(object : com.xxf.effect.recyclerview.animators.BaseItemAnimator.AnimatorListenerAdapter() {
          override fun onAnimationStart(animator: Animator) {
  ...
  private fun endChangeAnimation(infoList: MutableList<com.xxf.effect.recyclerview.animators.BaseItemAnimator.ChangeInfo>, item: RecyclerView.ViewHolder) {
  ...
  private fun endChangeAnimationIfNecessary(changeInfo: com.xxf.effect.recyclerview.animators.BaseItemAnimator.ChangeInfo) {
  ...
  private fun endChangeAnimationIfNecessary(
    changeInfo: com.xxf.effect.recyclerview.animators.BaseItemAnimator.ChangeInfo,
  ...
  override fun endAnimation(item: RecyclerView.ViewHolder) {
    ...
    check(!(removeAnimations.remove(item) && com.xxf.effect.recyclerview.animators.BaseItemAnimator.Companion.DEBUG)) { "after animation is cancelled, item should not be in " + "mRemoveAnimations list" }
    check(!(addAnimations.remove(item) && com.xxf.effect.recyclerview.animators.BaseItemAnimator.Companion.DEBUG)) { "after animation is cancelled, item should not be in " + "mAddAnimations list" }
    check(!(changeAnimations.remove(item) && com.xxf.effect.recyclerview.animators.BaseItemAnimator.Companion.DEBUG)) { "after animation is cancelled, item should not be in " + "mChangeAnimations list" }
    check(!(moveAnimations.remove(item) && com.xxf.effect.recyclerview.animators.BaseItemAnimator.Companion.DEBUG)) { "after animation is cancelled, item should not be in " + "mMoveAnimations list" }
    dispatchFinishedWhenDone()
  }
  ...
  inner class DefaultAddAnimatorListener(var viewHolder: RecyclerView.ViewHolder) :
    com.xxf.effect.recyclerview.animators.BaseItemAnimator.AnimatorListenerAdapter() {
    override fun onAnimationStart(animator: Animator) {
