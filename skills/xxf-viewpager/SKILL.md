---
name: xxf-viewpager
description: :lib_viewPager 的外部接入说明，面向 Maven 消费方。
---
...
`lib_viewPager` provides ViewPager helpers. Use the published Maven artifact from your app or feature module.
