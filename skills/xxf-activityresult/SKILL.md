...
description: :lib_activityresult 的外部接入说明，面向 Maven 消费方。
---
...
`lib_activityresult` provides Activity Result helpers. Use the published Maven artifact from your app or feature module.
