---
name: xxf-adapter
description: :lib_adapter 的外部接入说明，面向 Maven 消费方。
---
...
`lib_adapter` provides RecyclerView adapter helpers. Use the published Maven artifact from your app or feature module.
