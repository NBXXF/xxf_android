...
public final class JBinderParcel {
    ...
    public static void write(Parcel parcel, Object v) {
        if (v == null) {
            ...
            Class<?> jBinderInterface = JBinder.getJBinderInterface(v);
            if (jBinderInterface != null) {
                parcel.writeInt(VAL_OK_BINDER);
                parcel.writeString(jBinderInterface.getName());
                parcel.writeValue(JBinder.create((Class<Object>) jBinderInterface, v));
                return;
            }
            parcel.writeInt(VAL_DEFAULT);
            parcel.writeValue(v);
    ...
    public static Object read(Parcel parcel, ClassLoader loader) throws ClassNotFoundException {
        ...
        switch (type) {
            ...
            case VAL_OK_BINDER: {
                ...
                return JBinder.proxy(serviceClass, binder);
            }
            case VAL_ARRAY: {
