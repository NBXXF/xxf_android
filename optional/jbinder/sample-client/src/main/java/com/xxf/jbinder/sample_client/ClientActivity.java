...
import com.xxf.jbinder.sample_client.R;
import com.xxf.jbinder.sample_library.IRemoteService;
...
public class ClientActivity extends Activity implements ServiceConnection, LogUtils.Printer {
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        ...
        IRemoteService remoteService = JBinder.proxy(IRemoteService.class, service);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.vTestLocalService).setOnClickListener(v ->
                rebindService("com.xxf.jbinder.sample_client/.LocalService"));

        findViewById(R.id.vTestRemoteService).setOnClickListener(v ->
                rebindService("com.xxf.jbinder.sample_server/.RemoteService"));
