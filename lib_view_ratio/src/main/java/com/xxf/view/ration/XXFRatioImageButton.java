...
import com.xxf.view.round.XXFRoundImageButton;
 ...
 * </declare-styleable>
 */
public class XXFRatioImageButton extends XXFRoundImageButton implements XXFRatioWidget {

    private RatioLayoutDelegate mRatioLayoutDelegate;

    public XXFRatioImageButton(Context context) {
        super(context);
    }

    public XXFRatioImageButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        mRatioLayoutDelegate = RatioLayoutDelegate.obtain(this, attrs);
    }

    public XXFRatioImageButton(Context context, AttributeSet attrs, int defStyleAttr) {
