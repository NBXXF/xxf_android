...
public class XXFRatioRelativeLayout extends XXFRoundRelativeLayout implements XXFRatioWidget {

    private RatioLayoutDelegate mRatioLayoutDelegate;

    public XXFRatioRelativeLayout(Context context) {
        super(context);
    }

    public XXFRatioRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mRatioLayoutDelegate = RatioLayoutDelegate.obtain(this, attrs);
    }

    public XXFRatioRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
