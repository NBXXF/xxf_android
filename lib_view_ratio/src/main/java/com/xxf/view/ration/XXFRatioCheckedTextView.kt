...
public class XXFRatioCheckedTextView extends XXFRoundCheckedTextView implements XXFRatioWidget {

    private RatioLayoutDelegate mRatioLayoutDelegate;

    public XXFRatioCheckedTextView(Context context) {
        super(context);
    }

    public XXFRatioCheckedTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mRatioLayoutDelegate = RatioLayoutDelegate.obtain(this, attrs);
    }

    public XXFRatioCheckedTextView(Context context, AttributeSet attrs, int defStyleAttr) {
