...
public class XXFRatioTextView extends XXFRoundTextView implements XXFRatioWidget {

    private RatioLayoutDelegate mRatioLayoutDelegate;

    public XXFRatioTextView(Context context) {
        super(context);
    }

    public XXFRatioTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mRatioLayoutDelegate = RatioLayoutDelegate.obtain(this, attrs);
    }

    public XXFRatioTextView(Context context, AttributeSet attrs, int defStyleAttr) {
