 ...
 * </declare-styleable>
 */
public class XXFRatioButton extends XXFRoundButton implements XXFRatioWidget {

    private RatioLayoutDelegate mRatioLayoutDelegate;

    public XXFRatioButton(Context context) {
        super(context);
    }

    public XXFRatioButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        mRatioLayoutDelegate = RatioLayoutDelegate.obtain(this, attrs);
    }

    public XXFRatioButton(Context context, AttributeSet attrs, int defStyleAttr) {
