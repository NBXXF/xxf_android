...
public class XXFGradientLinearLayout extends XXFRoundLinearLayout {
    ...
    public XXFGradientLinearLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        GradientUtils.setGradientBackground(context, this, attrs);
    }

    public XXFGradientLinearLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
