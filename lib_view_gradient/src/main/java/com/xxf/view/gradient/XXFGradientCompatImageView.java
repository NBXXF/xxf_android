...
public class XXFGradientCompatImageView extends XXFRoundImageView {
    ...
    public XXFGradientCompatImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        GradientUtils.setGradientBackground(context, this, attrs);
    }

    public XXFGradientCompatImageView(Context context, AttributeSet attrs, int defStyleAttr) {
