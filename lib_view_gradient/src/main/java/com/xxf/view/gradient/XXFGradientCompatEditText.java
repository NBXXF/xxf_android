 ...
 * Description: 渐变背景组件
 */
public class XXFGradientCompatEditText extends XXFRoundEditText {
    public XXFGradientCompatEditText(Context context) {
        super(context);
    }

    public XXFGradientCompatEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        GradientUtils.setGradientBackground(context, this, attrs);
    }

    public XXFGradientCompatEditText(Context context, AttributeSet attrs, int defStyleAttr) {
