...
import com.xxf.view.round.XXFRoundRadioButton;
 ...
 * Description: 渐变背景组件
 */
public class XXFGradientCompatRadioButton extends XXFRoundRadioButton {
    public XXFGradientCompatRadioButton(Context context) {
        super(context);
    }

    public XXFGradientCompatRadioButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        GradientUtils.setGradientBackground(context, this, attrs);
    }

    public XXFGradientCompatRadioButton(Context context, AttributeSet attrs, int defStyleAttr) {
