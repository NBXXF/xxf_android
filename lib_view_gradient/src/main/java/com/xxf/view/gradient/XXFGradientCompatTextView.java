 ...
 * Description: 渐变组件
 */
public class XXFGradientCompatTextView extends XXFRoundTextView {
    public XXFGradientCompatTextView(Context context) {
        super(context);
    }

    public XXFGradientCompatTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        GradientUtils.setGradientBackground(context, this, attrs);
    }

    public XXFGradientCompatTextView(Context context, AttributeSet attrs, int defStyleAttr) {
