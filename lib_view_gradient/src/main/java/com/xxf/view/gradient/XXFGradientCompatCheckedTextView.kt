...
import com.xxf.view.round.XXFRoundCheckedTextView;
 ...
 * Description: 渐变背景组件
 */
public class XXFGradientCompatCheckedTextView extends XXFRoundCheckedTextView {
    public XXFGradientCompatCheckedTextView(Context context) {
        super(context);
    }

    public XXFGradientCompatCheckedTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        GradientUtils.setGradientBackground(context, this, attrs);
    }

    public XXFGradientCompatCheckedTextView(Context context, AttributeSet attrs, int defStyleAttr) {
