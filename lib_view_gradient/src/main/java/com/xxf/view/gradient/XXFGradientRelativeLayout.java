 ...
 * Description: 渐变背景组件
 */
public class XXFGradientRelativeLayout extends XXFRoundRelativeLayout {
    public XXFGradientRelativeLayout(Context context) {
        super(context);
    }

    public XXFGradientRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        GradientUtils.setGradientBackground(context, this, attrs);
    }

    public XXFGradientRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
