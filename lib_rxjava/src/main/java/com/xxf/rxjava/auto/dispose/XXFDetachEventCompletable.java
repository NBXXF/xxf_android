...
@RestrictTo(LIBRARY)
final class XXFDetachEventCompletable implements CompletableSource {
     ...
     *
     * @param view
     * @param checkAttached   是否检查attached
     */
    XXFDetachEventCompletable(View view, boolean checkAttached) {
        this.view = view;
